...
const doSocialLogin = async (type: number) => {
  ...
  let loginbackUrl =  domain + $path("/login/loginBack");
  // console.log("loginbackUrl",loginbackUrl)
  $api('member/auth/social-auth-redirect', {
    params: {"type": type, "redirectUri": redirect,"loginBack": decodeURIComponent(loginbackUrl)}
  }).then((res) => {
                  ...
                  <el-form>
                    <div class="mi-form__content">
                      ...
                      <el-form-item prop="password">
                        <el-input v-model="form.password" :placeholder="$t('Set password')"
                      ...
                      <el-form-item prop="confirmPassword">
                        <el-input v-model="form.confirmPassword" :placeholder="$t('Enter your password again')"
                      ...
                      <el-form-item>
                        <div class="flex">
                          <el-checkbox v-model="form.agreed" style="margin-right: 0.75rem;--mi-checkbox-height: 20px;"
