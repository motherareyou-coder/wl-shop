									...
									<el-form>
										<div class="mi-form__content">
											...
											<el-form-item prop="password">
												<el-input v-model="form.password" :placeholder="$t('Set password')" :type="showPsw1 ? '' : 'password'" class="mi-form-field__field">
													<template #suffix>
											...
											<el-form-item prop="confirmPassword">
												<el-input v-model="form.confirmPassword" :placeholder="$t('Enter your password again')" :type="showPsw2 ? '' : 'password'" class="mi-form-field__field">
													<template #suffix>
